<template>
  ...
  >
    <a href="#" @click="scrollToSection('main', $event)">
      <div
        class="w-22 md:w-26 h-fit rounded-md flex items-center justify-center md:-rotate-6 md:ml-4"
      >
    ...
    >
      ...
      <a
        href="#contact"
        class="block md:hidden text-black hover:text-blue-500 transition-colors duration-300 cursor-pointer"
        :class="{ 'text-purple-500': activeSection === 'contact' }"
